...
INSERT INTO `user` (`id_user`, `nama_lengkap`, `username`, `email`, `alamat`, `foto`, `level`, `password`) VALUES
(1, 'Abid Abiyyu Imani', 'abid', 'abid.abiyyu490@smk.belajar.id', 'Blok Cigoler Dusun Cuyu Nomor 64 RT.007 RW.005 Desa Kertajati Kecamatan Kertajati Kabupaten Majalengka', 'user2-160x160.jpg', 'Admin', '202cb962ac59075b964b07152d234b70'),
(2, 'Muhammad Balqi Agustian', 'balqi', 'balqi@gmail.com', 'Jati7', 'avatar5.png', 'Petugas', '202cb962ac59075b964b07152d234b70'),
(3, 'Erwin Nurjaya', 'erwin', 'erwin@gmail.com', 'Sukamulya', 'user8-128x128.jpg', 'Peminjam', '202cb962ac59075b964b07152d234b70');
